        ...
        <div className="card card-compact bg-base-100 shadow-xl mx-4 md:mx-auto mt-28 w-full md:w-1/2">
            ...
            <div className="card-body">
                ...
                <div className="card-actions w-full">
                    <button className='w-full px-5 py-2 rounded-lg bg-transparent hover:bg-gradient-to-tr from-cyan-500 to-blue-500 text-lg font-semibold text-white border-2 hover:border-0 border-cyan-500 hover:shadow-[1px_-1px_1rem_0px_cyan] '>Borrow</button>
