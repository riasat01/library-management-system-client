        ...
        <section className="w-full md:w-1/2 lg:w-1/3 mx-auto h-screen flex justify-center items-center">
            <form className="space-y-6">
                <section className="flex gap-6 justify-between items-center">
                    <input className="w-full rounded-2xl py-2 px-4 bg-slate-400 bg-opacity-50" type="text" name="first" placeholder="First Name" id="first" />
                    <input className="w-full rounded-2xl py-2 px-4 bg-slate-400 bg-opacity-50" type="text" name="last" placeholder="Last Name" id="last" />
                </section>
